...
insert into message (issue_id, text, created_at, updated_at) values (2, 'message4', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
insert into message (issue_id, text, created_at, updated_at) values (3, 'message5', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());